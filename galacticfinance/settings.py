"""
Django settings for galacticfinance project.
...
INSTALLED_APPS = [
    ...
    'portfolio.apps.PortfolioConfig', # Responsible for displaying the users portfolio details.
...
ROOT_URLCONF = 'galacticfinance.urls'
...
WSGI_APPLICATION = 'galacticfinance.wsgi.application'
